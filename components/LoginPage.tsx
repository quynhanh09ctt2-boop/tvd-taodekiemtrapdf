      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Hệ thống làm bài Trực tuyến</h1>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="text-5xl mb-4">📚</div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Hệ thống làm bài Trực tuyến</h1>
        ...
        {mode === null && (
          <div className="space-y-4">
            ...
            >
              ...
              <div className="text-sm opacity-90">Tham gia làm bài</div>
            </button>
        ...
        {mode === 'teacher' && (
          <div className="bg-white rounded-xl shadow-lg p-6 space-y-4">
            <div className="text-center mb-4">
              ...
              <p className="text-gray-600 mt-2">
                Bạn sẽ có quyền tạo, quản lý bài làm và xem kết quả
              </p>
            </div>
        ...
        <div className="mt-8 text-center text-gray-600 text-sm">
          <p>© 2026 Hệ thống làm bài Trực tuyến. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
